...
public class UserController {
	...
	private ProductService prodService;
		...
		@PostMapping("/users")
		public ResponseEntity<User> registerUserHandler(@Valid @RequestBody User user) throws LoginException {
		...
		public ResponseEntity<User> updateUserHandler(@Valid @RequestBody User user, @RequestParam("key") String key) throws LoginException {
...
//		public ResponseEntity<User> deleteUserHandler(@RequestParam("key")String key) throws LoginException {
...
//		public ResponseEntity<User> getCustomerDetailsHandler(@RequestParam(required = false) String key) throws LoginException {
...
//		}
		...
		public ResponseEntity<Product> getProductDetailsByNameHandler(@PathVariable("proName")String proName) throws ProductException{
			...
			Product product = prodService.getProductDetailsByName(proName);
